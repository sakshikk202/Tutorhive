    ...
    <div
      ...
      className={cn(
        'data-[active=true]:border-ring data-[active=true]:ring-ring/50 ' +
          ...
          'aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive dark:bg-input/30 ' +
          'border-input relative flex h-9 w-9 items-center justify-center border-y border-r text-sm shadow-xs ' +
